...
# Common Tree
git clone --depth=1 https://github.com/Thunderstorm1708/android_device_xiaomi_sm8350-common -b everest device/xiaomi/sm8350-common
...
git clone https://github.com/1xtAsh/vendor_lineage-priv_keys -b lineage-21 vendor/everest/signing/keys
